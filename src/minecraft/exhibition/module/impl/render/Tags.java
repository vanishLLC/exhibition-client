...
public class Tags extends Module {
    ...
    public void renderNametag(final EntityPlayer player, final double x, final double y, final double z) {
        ...
        RenderingUtil.rectangle(-width - 2, -(mc.fontRendererObj.FONT_HEIGHT * 2 - 8), width + 2, 0, -1728052224);
        ...
        mc.fontRendererObj.drawStringWithShadow(str, -mc.fontRendererObj.getStringWidth(player.getName() + " " + this.getHealth(player)) / 2, -mc.fontRendererObj.FONT_HEIGHT, color);
        ...
        mc.fontRendererObj.drawStringWithShadow((int)health + "", (mc.fontRendererObj.getStringWidth(player.getName() + " " + this.getHealth(player)) - mc.fontRendererObj.getStringWidth(this.getHealth(player)) * 2) / 2, -mc.fontRendererObj.FONT_HEIGHT, customColor.getRGB());
    ...
    public void renderArmor(final EntityPlayer player) {
        ...
        if (player.getHeldItem() != null) {
            ...
            this.renderItemStack(stock, xOffset, -25);
            xOffset += 16;
        }
        ...
        for (int index = 3; index >= 0; --index) {
            ...
            if (armourStack != null) {
                ...
                this.renderItemStack(renderStack2, xOffset, -25);
                xOffset += 16;
            }
        }
    }
