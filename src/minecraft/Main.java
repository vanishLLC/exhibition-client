...
public class Main {
    ...
    public static void bruh(String... p_main_0_) {
        ...
        ArgumentAcceptingOptionSpec var11 = var1.accepts("username").withRequiredArg().defaultsTo("GetAnAccountJoe", new String[0]);
        ...
        try {
            new MCHook(var42).bruhMinecraft(null);
        } catch (Exception e) {
            e.printStackTrace();
        }
