...
public class PlayerControllerMP
{
    ...
    public boolean onPlayerDamageBlock(BlockPos posBlock, EnumFacing directionFacing)
    {
        ...
        else if ((this.currentGameType.isCreative() || Client.getModuleManager().get(Freecam.class).isEnabled()) && this.mc.theWorld.getWorldBorder().contains(posBlock))
        {
            this.blockHitDelay = 5;
    ...
    public boolean onPlayerRightClickCheck(EntityPlayerSP player, WorldClient worldIn, ItemStack heldStack, BlockPos hitPos, EnumFacing side, Vec3 hitVec)
    {
        int oldItem = this.currentPlayerItem;
        {
            int i = this.mc.thePlayer.inventory.currentItem;
        ...
        {
            this.currentPlayerItem = oldItem;
            return false;
        }
        else
        {
    ...
    {
        // ChatUtil.debug(windowId + " " + slotId + " " + mouseButtonClicked + " " + mode);
    ...
    public void onStoppedUsingItem(EntityPlayer playerIn) {
        ...
        if((!module.isEnabled() || !(boolean)module.getSetting("AUTOBLOCK").getValue()) || (boolean)module.getSetting("AUTOBLOCK").getValue() && (Killaura.loaded.isEmpty() && Killaura.target == null)) {
