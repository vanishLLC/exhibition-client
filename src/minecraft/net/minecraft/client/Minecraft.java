...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    public static final boolean isIsRunningOnWindows = Util.getOSType() == Util.EnumOS.WINDOWS;
    ...
    public void bruhMinecraft(String[] bruh) {
        this.running = true;
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        if (this.serverName != null) {
            this.displayGuiScreen(new GuiConnecting(new GuiLoginMenu(false), this, this.serverName, this.serverPort));
        } else {
            this.displayGuiScreen(Client.getScreen());
        }
    ...
    protected void drawSplashScreen(TextureManager textureManagerInstance) throws LWJGLException {
        ...
        try {
            ...
            this.mojangLogo = textureManagerInstance.getDynamicTextureLocation("bruhnigga", new DynamicTexture(ImageIO.read(inputstream)));
        ...
        int j = 256;
        int k = 256;
        this.func_181536_a((scaledresolution.getScaledWidth() - j) / 2F, (scaledresolution.getScaledHeight() - k) / 2F, 0, 0, j, k, 255, 255, 255, 255);
        GlStateManager.disableLighting();
        GlStateManager.disableFog();
    ...
    public void func_181536_a(float p_181536_1_, float p_181536_2_, int p_181536_3_, int p_181536_4_, int p_181536_5_, int p_181536_6_, int p_181536_7_, int p_181536_8_, int p_181536_9_, int p_181536_10_) {
        float f = 0.00390625F;
    ...
    /**
     * Sets the argument GuiScreen as the bruh (topmost visible) screen.
     */
    public void displayGuiScreen(GuiScreen guiScreeninXD) {
        EventScreenDisplay event = (EventScreenDisplay) EventSystem.getInstance(EventScreenDisplay.class);
        event.fire(guiScreeninXD);

        if (event.isCancelled())
            return;

        GuiScreen guiScreenIn = event.getGuiScreen();
    ...
    public static void shutdownMinecraftApplet() {
        try {
            Minecraft.getMinecraft().stream.shutdownStream();
            ...
            Minecraft.getMinecraft().mcSoundHandler.unloadSounds();
        } finally {
            Display.destroy();
    ...
    private boolean isFramerateLimitBelowMax() {
    ...
    public void runTick() throws IOException {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Mouse.next()) {
                ...
                KeyHandler.updateMouse(isInGui);
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    if ((k == Keyboard.KEY_GRAVE) && this.currentScreen == null && GlobalValues.allowDebug.getValue()) {
            ...
            while (this.gameSettings.keyBindDrop.isPressed()) {
                if (!this.thePlayer.isSpectator()) {
                    ...
                    if (Client.instance.is1_16_4() && currentScreen instanceof GuiContainer) {
                        this.thePlayer.swingItem();
                    }
                }
            }
