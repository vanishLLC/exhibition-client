...
public class ModelDragon extends ModelBase
{
    ...
    public ModelDragon(float p_i46360_1_)
    {
        ...
        this.setTextureOffset("rearleg.bruh", 0, 0);
        this.setTextureOffset("rearfoot.bruh", 112, 0);
        this.setTextureOffset("rearlegtip.bruh", 196, 0);
        this.setTextureOffset("head.upperhead", 112, 30);
        this.setTextureOffset("wing.bone", 112, 88);
        this.setTextureOffset("head.upperlip", 176, 44);
        this.setTextureOffset("jaw.jaw", 176, 65);
        this.setTextureOffset("frontleg.bruh", 112, 104);
        this.setTextureOffset("wingtip.bone", 112, 136);
        this.setTextureOffset("frontfoot.bruh", 144, 104);
        this.setTextureOffset("neck.box", 192, 104);
        this.setTextureOffset("frontlegtip.bruh", 226, 138);
