...
import exhibition.module.impl.render.MoreParticles;
...
public class EffectRenderer
{
    ...
    {
        int multiplier = particleTypes == EnumParticleTypes.CRIT ? ((MoreParticles) Client.getModuleManager().get(MoreParticles.class)).getCritMulti() : particleTypes == EnumParticleTypes.CRIT_MAGIC ? ((MoreParticles) Client.getModuleManager().get(MoreParticles.class)).getEnchantMulti() : 1 ;
