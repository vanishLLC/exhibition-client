...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdate() {
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ))) {
            ...
            if (this.isRiding()) {
                ...
                em.fire(this.getEntityBoundingBox().minY, this.rotationYaw, this.rotationPitch, this.onGround);
                if (em.isCancelled()) {
                    em.fire(); // POST
                    return;
                }
    ...
    public void onUpdateWalkingPlayer() {
        ...
        if (this.isCurrentViewEntity()) {
            ...
            double var9 = em.getYaw() - this.lastReportedYaw;
            double var11 = em.getPitch() - this.lastReportedPitch;
            boolean var13 = var3 * var3 + var5 * var5 + var7 * var7 > 0.00090D || this.positionUpdateTicks >= 20 || em.shouldForcePos();
            ...
            if (em.getPostPacket() != null) {
                this.sendQueue.addToSendQueue(em.getPostPacket());
            }

            ++this.positionUpdateTicks;
            if (var13 || em.shouldAlwaysSend() || em.shouldForcePos()) {
