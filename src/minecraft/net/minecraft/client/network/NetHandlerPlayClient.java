...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    public void handleSetSlot(S2FPacketSetSlot packetIn) {
        ...
        if (packetIn.func_149175_c() == -1) {
            ...
            if (packetIn.func_149175_c() == 0 && packetIn.getSlotID() >= 36 && packetIn.getSlotID() < 45) {
                ItemStack itemstack = entityplayer.inventoryContainer.getSlot(packetIn.getSlotID()).getStack();
                ...
                entityplayer.inventoryContainer.putStackInSlot(packetIn.getSlotID(), packetIn.func_149174_e());
            } else if (packetIn.func_149175_c() == entityplayer.openContainer.windowId && (packetIn.func_149175_c() != 0 || !flag)) {
                entityplayer.openContainer.putStackInSlot(packetIn.getSlotID(), packetIn.func_149174_e());
            }
        }
    }
    ...
    public void handlePlayerListItem(S38PacketPlayerListItem packetIn) {
        ...
        for (S38PacketPlayerListItem.AddPlayerData s38packetplayerlistitem$addplayerdata : packetIn.getPlayerList()) {
