...
public class SoundHandler implements IResourceManagerReloadListener, ITickable {
    ...
    public void loadCustomSound(ResourceLocation p_147693_1_) {
        SoundEventAccessorComposite var3 = new SoundEventAccessorComposite(p_147693_1_, 1.0D, 1.0D, SoundCategory.MUSIC);
        this.sndRegistry.registerSound(var3);
        ResourceLocation var11 = new ResourceLocation(p_147693_1_.getResourcePath());
        ...
        SoundEventAccessor var10 = new SoundEventAccessor(new SoundPoolEntry(var11, (double) 1, (double) 1, false), 1);
