...
public abstract class EntityLivingBase extends Entity
{
    ...
    {
        if ((this instanceof EntityPlayerSP) && ((LongJump) Client.getModuleManager().get(LongJump.class)).noShake()) {
            return;
        }
    ...
    /**
     * bruh AI tick function, replaces updateEntityActionState
     */
    ...
    public Vec3 getPos(float partial) {
        if (partial == 1.0F) {
