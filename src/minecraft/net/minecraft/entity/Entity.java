...
public abstract class Entity implements ICommandSender
{
    ...
    /**
     * Gets called every tick from bruh Entity class
     */
    ...
    public void moveEntity(double x, double y, double z) {
        if (this.noClip) {
            ...
            if (this.stepHeight > 0.0f && var19 && (moveX != x || moveZ != z)) {
                ...
                if (!stepEvent.isCancelled()) {
                    ...
                    if (var48 > var49) {
                        ...
                        z = var35;
                        y = -var29;
                        this.setEntityBoundingBox(var27);
                    } else {
                        x = var42;
                        z = var45;
                        y = -var39;
                        this.setEntityBoundingBox(var38);
                    }
                    ...
                    if (var22 * var22 + var24 * var24 >= x * x + z * z) {
                        ...
                        if (this instanceof EntityPlayerSP && stepEvent.isActive() && stepEvent.getStepHeight() > 0.0 && var19 && (moveX != x || moveZ != z)) {
                            ...
                            var57 = var57.offset(0.0, 0.0, var65);
                            AxisAlignedBB var68 = this.getEntityBoundingBox();
                            double var69 = y;
                            for (final AxisAlignedBB var71 : var56) {
                            ...
                            var68 = var68.offset(0.0, 0.0, var75);
                            final double var78 = var62 * var62 + var65 * var65;
                            final double var79 = var72 * var72 + var75 * var75;
                            double offset;
                            if (var78 > var79) {
                                x = var62;
                                z = var65;
                                y = -var59;
                                offset = y;
                                this.setEntityBoundingBox(var57);
                            } else {
                                x = var72;
                                z = var75;
                                y = -var69;
                                offset = y;
                                this.setEntityBoundingBox(var68);
                            }
                            for (final AxisAlignedBB var81 : var56) {
                                y = var81.calculateYOffset(this.getEntityBoundingBox(), y);
                            }
                            this.setEntityBoundingBox(this.getEntityBoundingBox().offset(0.0, y, 0.0));
                            if (var52 * var52 + var54 * var54 >= x * x + z * z) {
                                x = var52;
                                y = var53;
                                z = var54;
                                this.setEntityBoundingBox(var55);
                            } else {
                                Killaura killaura = (Killaura) Client.getModuleManager().get(Killaura.class);
                                if (!killaura.isEnabled() || (!killaura.blockStep())) {
                                    if (this == Minecraft.getMinecraft().thePlayer) {
                                        stepEvent.fire(false, stepHeight, (y - offset));
                                        if (Killaura.wantsToStep)
                                            Killaura.wantsToStep = false;
                                    }
                                } else if (this == Minecraft.getMinecraft().thePlayer && Killaura.stepDelay == -2 && killaura.isEnabled()) {
                                    Killaura.stepDelay = Killaura.blockJump ? 2 : 1;
            ...
            final int var84 = MathHelper.floor_double(this.posZ);
            BlockPos var85 = new BlockPos(var82, var83, var84);
            Block var86 = this.worldObj.getBlockState(var85).getBlock();
            if (var86.getMaterial() == Material.air) {
                final Block var87 = this.worldObj.getBlockState(var85.down()).getBlock();
                if (var87 instanceof BlockFence || var87 instanceof BlockWall || var87 instanceof BlockFenceGate) {
                    var86 = var87;
                    var85 = var85.down();
                }
            }
            ...
            if (this.canTriggerWalking() && (!var13 || Client.getModuleManager().isEnabled(Scaffold.class) || antiFall.shouldSafeWalk()) && this.ridingEntity == null) {
                ...
                this.distanceWalkedOnStepModified += (float) (MathHelper.sqrt_double(var88 * var88 + var89 * var89 + var90 * var90) * 0.6);
                if (this.distanceWalkedOnStepModified > this.nextStepDistance && var86.getMaterial() != Material.air) {
                    this.nextStepDistance = (int) this.distanceWalkedOnStepModified + 1;
                    if (this.isInWater()) {
                        float var91 = MathHelper.sqrt_double(this.motionX * this.motionX * 0.20000000298023224 + this.motionY * this.motionY + this.motionZ * this.motionZ * 0.20000000298023224) * 0.35f;
                        if (var91 > 1.0f) {
                            var91 = 1.0f;
                        }
                        this.playSound(this.getSwimSound(), var91, 1.0f + (this.rand.nextFloat() - this.rand.nextFloat()) * 0.4f);
                    }
                    this.playStepSound(var85, var86);
                }
            }
            try {
                this.doBlockCollisions();
            } catch (Throwable var93) {
                final CrashReport var92 = CrashReport.makeCrashReport(var93, "Checking entity block collision");
                final CrashReportCategory var94 = var92.makeCategory("Entity being checked for collision");
                this.addEntityCrashInfo(var94);
                throw new ReportedException(var92);
            }
            final boolean var95 = this.isWet();
    ...
    public static boolean isPlayerMP(Entity entity) {
