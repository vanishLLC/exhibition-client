...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    public boolean illegalSpawn = false;
    public int illegalTeleports = 0;
    ...
    public void onDeath(DamageSource cause)
    {
        ...
        event.fire();
        if (this instanceof EntityPlayerSP && event.isCancelled()){
            return;
        }
        super.onDeath(cause);
    ...
    public boolean isImportant() {
        return TargetESP.isPriority(this) || FriendManager.isFriend(this.getName());
    }
