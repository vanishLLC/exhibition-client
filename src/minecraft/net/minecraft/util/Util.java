...
public class Util {
    ...
    public static class EnumOS
    {
        public static final EnumOS LINUX = new EnumOS("LINUX"),
                SOLARIS = new EnumOS("SOLARIS"),
                WINDOWS = new EnumOS("WINDOWS"),
                OSX = new EnumOS("OSC"),
                UNKNOWN = new EnumOS("UNKNOWN");

        private String name;

        public EnumOS(String name) {
            this.name = name;
        }
