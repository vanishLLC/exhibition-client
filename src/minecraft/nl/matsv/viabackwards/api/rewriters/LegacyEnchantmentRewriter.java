...
public class LegacyEnchantmentRewriter {
    ...
    public void rewriteEnchantmentsToClient(CompoundTag tag, boolean storedEnchant) {
        ...
        for (Tag enchantmentEntry : enchantments.clone()) {
            Short newId;
            if (((CompoundTag) enchantmentEntry).get("id").getValue() instanceof String){
                newId = Short.valueOf(String.valueOf((Enchantment.getEnchantmentByLocation((String) ((CompoundTag) enchantmentEntry).get("id").getValue()).effectId)));
            } else {
                newId =  Short.valueOf(String.valueOf(((CompoundTag) enchantmentEntry).get("id").getValue()));
            }
